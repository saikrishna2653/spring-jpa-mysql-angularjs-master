		...
		<div class="row">
			<div ng-controller="postController" class="col-md-3">
				<form name="customerForm" ng-submit="submitForm()">
					...
					<label>DOB</label>
					<input type="date" name="dob"	class="form-control" ng-model="dob" />
		...
		<div class="row">
			...
			<div ng-controller="getcustomerController" class="col-md-3">
				...
				<div ng-show="showCustomer">
					...
					Last Name: {{customer.data.lastName}}<br />
					DOB: {{customer.data.dob}}<br />
					User Name: {{customer.data.userName}}<br />
